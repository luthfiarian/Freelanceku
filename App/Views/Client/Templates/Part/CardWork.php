...
<div class="w-full rounded-lg pb-2 border shadow-md bg-gradient-to-tr from-primary to-slate-300">
    <img src="Public/dist/image/example-bg-work.jpg" width="100%" alt="Latar Belakang Pekerjaan" class="rounded-t-lg hover:grayscale-[50%]">
    <div class="w-full p-1">
        <p class="font-semibold"><?php echo $Work["work_name"] ?></p>
        <p class="text-xs">
            <!-- Limit Description -->
            <?php 
        ...
        <div class="border my-2 py-1 flex px-2 w-full rounded-lg">
            ...
            <span class="md:w-2/3 lg:w-1/2 text-right text-xs md:text-sm lg:text-base"><?php echo $Work["work_startdate"] ?></span>
        </div>
        <div class="border my-2 py-1 flex px-2 w-full rounded-lg">
            ...
            <span class="w-2/3 text-right text-[8px] md:text-xs lg:text-sm"><?php echo $Work["work_type"] ?></span>
        </div>
        <div class="border my-2 py-1 flex px-2 w-full rounded-lg">
            ...
            <span class="w-1/2 text-right"><?php echo " / " . $Work["work_maxuser"] ?></span>
        </div>
        <div class="border my-2 py-1 flex px-2 w-full rounded-lg">
            <span class="w-full text-center"><?php if($Work["work_status"] == 0){ echo "Berjalan"; } else { echo "Selesai"; } ?></span>
        </div>
        <a href="history/<?php echo $Work["id"] ?>" class="w-full text-right text-sm inline-flex items-center px-3 py-2 font-medium text-primary bg-secondary rounded-lg hover:bg-forth focus:ring-4 focus:outline-none focus:ring-secondary">
            Lihat
