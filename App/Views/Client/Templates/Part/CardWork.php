...
<div class="w-full rounded-lg pb-2 border shadow-md bg-gradient-to-tr from-primary to-slate-300">
    <img src="<?php echo $Work["work_image"] ?>" width="100%" alt="Latar Belakang Pekerjaan" class="rounded-t-lg hover:grayscale-[50%]">
    <div class="w-full p-1">
        ...
        <div class="border my-2 py-1 flex px-2 w-full rounded-lg">
            ...
            <span class="w-2/3 text-right text-[8px] md:text-xs lg:text-sm"><?php echo $Work["work_field"] ?></span>
        </div>
        <div class="border my-2 py-1 flex px-2 w-full rounded-lg">
            ...
            ?>
            <span class="w-1/2 text-right"><?php echo $Workers . " / " . $Work["work_maxuser"] ?></span>
        </div>
        <div class="border my-2 py-1 flex px-2 w-full rounded-lg">
