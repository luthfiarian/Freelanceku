                ...
                <div class="p-4 md:p-5 space-y-4">
                    <div class="w-full flex">
                        <div class="w-1/3 mr-2 flex self-center">
                            <img src="<?php echo BASE_URI . $Data->userdb->data_photo ?>" class="mx-auto" alt="Foto <?php echo $Data->userapi->data->identity->first_name ?>" width="50%">
                        </div>
                        <div class="w-2/3">
                            ...
                            <table class="table table-auto w-full text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr class="group">
                                        ...
                                        <td><a href="<?php echo !empty($Partner["partner_file"]) ? BASE_URI . $Partner["partner_file"] : "#" ?>" class="bg-secondary rounded-lg text-primary py-1 px-4">Unduh Berkas</a></td>
                                    </tr>
                                    <?php endwhile ?>
                                </tbody>
                            </table>
