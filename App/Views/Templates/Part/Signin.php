            ...
            <div class="p-4 md:p-5">
                <form class="space-y-4" method="post" action="App/Controllers/Signin.php">
                    <div>
                        ...
                        <input type="email" name="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-third focus:border-third block w-full p-2.5" placeholder="name@company.com" required>
                    </div>
                    <div>
